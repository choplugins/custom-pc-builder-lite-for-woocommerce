    ...
    class custom_pc_builder_lite_for_woocommerce{
                ...
                <div class="nk-popup fade" id="nk_custom_pc_builder_popup">
                    ...
                    <div class="nk-popup-inner">
                        <div class="nk-popup-header bg-primary">
                            <div class="left-col">
                                <span class="title"><?= esc_html(__('Choose Accessories','nk-custom-pc-builder'))?></span>
                            </div>
                            <div class="right-col">
        ...
        public function wp_enqueue_scripts(){
            if(is_page(get_option('nkcpcb_share_page',0))) {
                ...
                wp_enqueue_script('nk-custom-pc-builder-lite', $this->assets_uri("/js/frontend.js"), array('jquery','jquery-blockui'), false, true);
            }
        }
